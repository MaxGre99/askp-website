	...
	return (
		<>
			<section className='flex flex-col gap-3'>
				<h1 className='font-bad-script text-white'>Наши новости:</h1>
				<Swiper
			...
			<section className='flex flex-col gap-3'>
				<h1 className='font-bad-script text-white'>Будущие меорприятия:</h1>
			...
			<section className='text-white flex flex-col gap-5 items-center'>
				<h1 className='font-bad-script'>Форма обратной связи</h1>
				<div className='relative flex bg-white/20 rounded-full w-fit'>
					...
					<Button
						...
						className='relative z-10 px-6 py-3 text-white font-medium w-1/2! flex justify-center h-fit! font-inter text-lg hover:bg-transparent!'
					>
						Сотрудничество
					</Button>
