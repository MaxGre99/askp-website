...
export const ProfileCard = ({ profile }: { profile: Profile }) => {
	return (
		<div className='bg-white/70 rounded-2xl backdrop-blur-2xl max-w-[280px] max-h-[524px] w-[280px] h-[524px] flex flex-col gap-2 items-center p-3'>
			...
			<div className='flex flex-1 w-full flex-col gap-2 justify-start items-center text-center wrap-anywhere overflow-hidden'>
				...
				<p className='font-bold text-ellipsis max-w-full'>г. {profile.city}</p>
