...
export const ProfileCard = ({ profile }: { profile: Profile }) => {
	return (
		<Link href={`/specialists/${profile.userId}`}>
			<div className='bg-white/70 rounded-2xl backdrop-blur-2xl max-w-[280px] max-h-[524px] w-[280px] h-[524px] flex flex-col gap-2 items-center p-3 transition hover:scale-[1.01]'>
